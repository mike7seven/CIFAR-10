...
for epoch in range(num_epochs):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if i % 100 == 99:    # print every 100 mini-batches (adjusted for larger batch size)
            print(f'[{epoch + 1}, {i + 1:5d}] loss: {running_loss / 100:.3f}')
            running_loss = 0.0

training_time = time.time() - start_time
print(f'Finished Training in {training_time:.2f} seconds on {device}')
...
# Device was already set at the top of the script
# On Mac with Apple Silicon, this will be 'mps'
print(f'Training device was: {device}')
